...
public class Orders extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        checkout=v.findViewById(R.id.button2);
        if(user != null) {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    /*try*/
                        ...
                        for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                         ...
                         if (ord_array.isEmpty()){Toast.makeText(getContext(),"No Orders Yet",Toast.LENGTH_SHORT).show();}
                }
...
//                        startActivityForResult(i, 100);
        ...
        checkout.setOnClickListener(new View.OnClickListener() {
            ...
            Toast.makeText(getContext(),"Sending your orders to Seller's Account",Toast.LENGTH_SHORT).show();
